...
class Cliente {
    ...
    public static function ObtenerTiempoEstimadoSegunPedidoYMesa($codigo_pedido, $codigo_mesa){
        ...
        $consulta = $objAccesoDatos->prepararConsulta("SELECT a.nombre_cliente as Nombre, b.codigo as Codigo_Mesa, a.codigo as Codigo_Pedido, a.tiempo_estimado as Tiempo_Estimado,
